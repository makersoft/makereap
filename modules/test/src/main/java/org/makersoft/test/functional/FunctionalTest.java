/*
 * @(#)FunctionalTest.java 2013-1-22 下午11:57:14
 *
 ...
 *
 */
package org.makersoft.test.functional;

import org.makersoft.test.BaseTest;
...
//
//	/**
//	 * Sends a POST request to the application under tests as a multipart form. Designed for file
//	 * upload testing.
//	 * 
//	 * @param url
//	 *            relative url such as <em>"/products/1234"</em>
...
//		final Future invocationResult = TestEngine.functionalTestsExecutor
//				.submit(new Invoker.Invocation() {
//
//					@Override
...
//						return new InvocationContext(Http.invocationType, request.invokedMethod
//								.getAnnotations(), request.invokedMethod.getDeclaringClass()
//								.getAnnotations());
//					}
//
//				});
...
//		Request request = Request.createRequest(null, "GET", "/", "", null, null, null, null,
//				false, 80, "localhost", false, null, null);
//		return request;
//	}
//
//	// Assertions
...
//	 * 
//	 * @param pattern
//	 *            a regular expression pattern or a regular text, ( which must be escaped using
//	 *            Pattern.quote)
//	 * @param response
//	 *            server response
//	 */
...
//
//	/**
//	 * Verify response charset encoding, as returned by the server in the Content-Type header. Be
//	 * aware that if no charset is returned, assertion will fail.
//	 * 
//	 * @param charset
...
//		assertTrue("Response contentType unmatched : '" + contentType + "' !~ '"
//				+ response.contentType + "'", response.contentType.startsWith(contentType));
//	}
//
//	/**
...
//		assertNotNull("Response header " + headerName + " missing",
//				response.headers.get(headerName));
//		assertEquals("Response header " + headerName + " mismatch", value,
//				response.headers.get(headerName).value());
//	}
//
//	/**
